...
class Game extends Phaser.Scene {
  ...
  create(data) {
    ...
    this.anims.create({
      key: 'hero-pivoting',
      frames: this.anims.generateFrameNames('hero-pivot-sheet')
    })
    ...
    this.anims.create({
      key: 'hero-flipping',
      frames: this.anims.generateFrameNames('hero-flip-sheet'),
      frameRate: 30,
      repeat: 0
    })
    ...
    this.anims.create({
      key: 'hero-dead',
      frames: this.anims.generateFrameNames('hero-die-sheet')
    })
  ...
  addMap() {
    ...
    this.map.getObjectLayer('Objects').objects.forEach(object => {
      ...
      if (object.gid === 7) {
        ...
        spike.setOrigin(0, 1)
        spike.setSize(object.width - 10, object.heigh - 10)
